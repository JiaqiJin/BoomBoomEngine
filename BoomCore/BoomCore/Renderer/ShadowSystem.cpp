...
#include "RenderTarget/AABBBoundingBox.h"
...
namespace Kawaii
{
	...
	void ShadowSystem::renderShadow(int width, int height, RenderTarget::ptr drawableList, Light::ptr light)
	{
		if (m_first)
		{
			m_first = false;
	...
	void ShadowSystem::setShadowCamera(RenderTarget::ptr drawableList, Light::ptr light)
	{
